        ...
        <div className={styles.heroContent}>
          ...
          <div className={styles.branchList}>
            <div className={styles.branchItem}>
              ...
              <span className={styles.branchLink}>Overheid</span>
            </div>
            <div className={styles.branchItem}>
              <svg
                className={styles.branchIcon}
              ...
              <span className={styles.branchLink}>Bedrijven</span>
            </div>
            <div className={styles.branchItem}>
              <svg
                className={styles.branchIcon}
              ...
              <span className={styles.branchLink}>Leveranciers</span>
            </div>
          </div>
      ...
      <div className={styles.featureBanner}>
        <div className={styles.featuresList}>
          <div className={styles.featureItem}>
            ...
            <span>
              <strong>WCAG 2.2</strong> onderzoeken
            </span>
          </div>
          <div className={styles.featureItem}>
            <svg
            ...
            <span>
              Rapport voor <strong>toegankelijkheidsverklaring</strong>
            </span>
          </div>
          <div className={styles.featureItem}>
            <svg
            ...
            <span>
              Ga voor <strong>Waarmerk drempelvrij.nl</strong>
            </span>
          </div>
          <div className={styles.featureItem}>
            <svg
            ...
            <span>
              Alle hulp bij de <strong>European Acessibility Act</strong>
            </span>
          </div>
        </div>
      </div>
